...
export const Checkbox: React.FC<CheckboxProps> = ({
  ...
  <AriaCheckbox.Checkbox
    {...rest}
    className={twMerge(
      "flex gap-2 items-start group text-grayscale-500",
      className as string
    )}
  >
    <div className="h-4 w-4 mt-1 group-data-[selected]:bg-black group-data-[selected]:border-black group-hover:group-data-[selected]:bg-grayscale-600 group-hover:group-data-[selected]:border-grayscale-600 text-transparent group-data-[selected]:text-white transition-colors border border-grayscale-200 group-hover:border-grayscale-600 flex justify-between items-center">
