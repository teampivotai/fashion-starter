...
export default function AccountLayout(props: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex max-md:flex-col">
      <div className="sticky left-0 shrink-0 top-0 md:max-w-75 lg:max-w-93 py-8 max-md:mt-18 max-md:top-18 md:pt-45 md:pb-9 max-md:border-b max-md:border-grayscale-200 max-md:overflow-x-auto bg-white md:bg-grayscale-50 w-full h-21 md:h-screen z-10">
      ...
      <div className="max-md:px-4 overflow-hidden max-md:container max-md:mx-auto md:px-10 pt-8 md:pt-45 pb-36 w-full lg:max-w-200 xl:mx-auto 2xl:ml-30">
        {props.children}
