...
export default function AccountLayout(props: { children: React.ReactNode }) {
  return (
    <div className="flex max-md:flex-col">
      ...
      <div className="max-md:px-4 overflow-hidden max-md:container max-md:mx-auto md:px-10 pt-10 md:pt-45 pb-26 md:pb-36 w-full lg:max-w-200 xl:mx-auto 2xl:ml-30">
        {props.children}
      </div>
    </div>
  )
